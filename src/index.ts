...
<<<<<<< HEAD
// ===== RUTA: OBTENER QR PARA LA VISTA DINÁMICA =====
=======
...
app.get('/payment/success', async (req, res) => {
    ...
    if (commerceId) {
        let phoneNumber = phoneParam || '5215643652322';
...
<<<<<<< HEAD
            ...
            console.warn(`⚠️ No se pudo obtener el teléfono de Supabase, usando por defecto.`);
        }
...
app.listen(Number(PORT), '0.0.0.0', async () => {
    ...
    // 🤖 INICIAR AUTOMÁTICAMENTE EL BOT DE PRUEBA AL ARRANCAR
    const COMERCIO_PRUEBA_ID = "comercio_principal";
    const TELEFONO_PRUEBA = "525670500038";
    
    try {
        console.log(`🤖 Iniciando automáticamente el bot de WhatsApp para ${TELEFONO_PRUEBA}...`);
        await startWhatsAppBotForCommerce(COMERCIO_PRUEBA_ID, TELEFONO_PRUEBA, false);
    } catch (error) {
