...
console.log("LLAVE FACTURAPI:", process.env.FACTURAPI_SECRET_KEY ? "SÍ" : "NO");
console.log("LLAVE GEMINI:", process.env.GEMINI_API_KEY ? "SÍ" : "NO");

const facturapi = new Facturapi(process.env.FACTURAPI_SECRET_KEY || "");

// Inicialización limpia usando la variable de entorno GEMINI_API_KEY por defecto
